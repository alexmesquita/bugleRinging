export const playListData = [
  {
    ...
    url: require('../assets/audios/music/zero.mp3'),
    uri: 'https://mega.nz/file/HNQnAbYb#3NRZb0K3MVoG4PYLFz9ipbwSwGc0gr_vFe_byi0Mxos.mp3',
  },
  {
    id: 1,
    ...
    url: require('../assets/audios/music/one.mp3'),
    uri: 'http://webaudioapi.com/samples/audios/music-tag/chrono.mp3',
  },
  {
    id: 2,
    ...
    url: require('../assets/audios/music/two.mp3'),
    uri: 'http://webaudioapi.com/samples/audios/music-tag/chrono.mp3',
  },
  {
    id: 3,
    ...
    url: require('../assets/audios/music/three.mp3'),
    uri: 'http://webaudioapi.com/samples/audios/music-tag/chrono.mp3',
  },
  {
    id: 4,
    ...
    url: require('../assets/audios/music/four.mp3'),
    uri: 'http://webaudioapi.com/samples/audios/music-tag/chrono.mp3',
  },
]
